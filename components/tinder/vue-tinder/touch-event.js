...
export default {
  methods: {
     ...
     */
    start(e) {
		// console.log('开始移动啦', e, this.state, this.size, this.status)
     ...
     */
    move(e) {
		// console.log('正在移动啦', e, this.state, e.clientX)
      e.preventDefault()
      const state = this.state
      if (
        state.touchId === null ||
	  ...
	  // console.log('正在移动啦', this.state, state.move)
    },
    /**
     * 移动结束，分析行为
     * @param {Object} e 触摸/鼠标事件
     */
		...
		// console.log('移动结束啦', e, this.status, this.state)
